...
public class RequestLogInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) throws Exception {
        ...
        if (handler instanceof HandlerMethod) {
            ...
            logMsg.append("Params: ").append(toJsonString(params)).append("\n");
            String formattedTime = LocalDateTime.now().format(DateTimeFormatter.ofPattern(DateConstants.DATE_TIME_FORMAT));
            logMsg.append("Request Time: ").append(formattedTime).append("\n");
